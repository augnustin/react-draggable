(function (global, factory) {
	...
	*/
	...
	function canDragX(draggable /*: Draggable*/) /*: boolean*/ {
	  return draggable.props.axis === 'both' || draggable.props.axis === 'x' || draggable.props.axis === 'exclude' && draggable.state.currentAxis !== 'y';
	}

	function canDragY(draggable /*: Draggable*/) /*: boolean*/ {
	  return draggable.props.axis === 'both' || draggable.props.axis === 'y' || draggable.props.axis === 'exclude' && draggable.state.currentAxis !== 'x';
	}
	...
	var Draggable = function (_React$Component) {
	  ...
	  function Draggable(props /*: DraggableProps*/) {
	    ...
	    _this.onDrag = function (e, coreData) {
	      ...
	      if (_this.props.axis === 'exclude' && _this.state.currentAxis === 'none') {
	        _this.setState({
